...
class PrettyNumbersSpec extends Specification {
  ...
  "Function getNaturalNumbers" should {
    ...
    "generate correct range of integers" in {
      getNaturalNumbers(10).toList mustEqual
  ...
  "Function getTriangularNumbers" should {
    ...
    "generate correct list of triangular number" in {
      getTriangularNumbers(36) mustEqual
        List(0,1,3,6,10,15,21,28,36,45,55,66,78,91,105,120,136,153,
  ...
  "Function getPyramidalNumbers" should {
    ...
    "generate correct list of pyramidal number" in {
      getPyramidalNumbers(32) mustEqual
        List(0,1,5,14,30,55,91,140,204,285,385,506,650,819,
          1015,1240,1496,1785,2109,2470,2870,3311,3795,4324,
          4900,5525,6201,6930,7714,8555,9455,10416,11440)
    }
  }
